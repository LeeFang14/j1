...
describe("Q17：運用 Borda Count。算出下面的候選人分數。", () => {
  test(`輸入"候選人與投票數據"，會輸出\n候選人「1」每個順位分數:204分+5分+23分+21分=總得分數253分\n候選人「3」每個順位分數:153分+20分+69分+63分=總得分數305分\n候選人「2」每個順位分數:102分+15分+92分+42分=總得分數251分\n候選人「4」每個順位分數:51分+10分+46分+84分=總得分數191分`, () => {
...
describe("測試 Q17 增加候選人、投票輪次，並更改候選人名稱、票數情形", () => {
  test(`輸入"候選人與投票數據"，會輸出\n候選人「小明」每個順位分數:75分+63分+70分+35分+150分=總得分數393分\n候選人「小美」每個順位分數:60分+42分+140分+7分+30分=總得分數279分\n候選人「小華」每個順位分數:45分+21分+175分+14分+60分=總得分數315分\n候選人「小白」每個順位分數:30分+105分+35分+28分+120分=總得分數318分\n候選人「小紅」每個順位分數:15分+84分+105分+21分+90分=總得分數315分`, () => {
    const originalVoting = [
